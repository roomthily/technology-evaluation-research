...
<div class="guidelines">
    ...
    <div class="criteria">
        ...
        <div class="criterion">
            <div class="revisions">
                <p class="original">For software, a best-practice guideline is selected and code is validated against it.</p>
            </div>
            <div class="metadata">
                <h4>Grouping</h4>
                <p></p>
        ...
        <div class="criterion">
            <div class="revisions">
                <p class="original">Is task-oriented or objective-oriented.</p>
            </div>
            <div class="metadata">
                <h4>Grouping</h4>
                <p></p>
